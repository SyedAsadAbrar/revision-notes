...
* **Four principles** of OOP:
  ...
  * **Inheritance** - Establishes a **child-parent** relationship, making all properties and methods of a certain class **available to a child class**, forming a hierarchiacal relationship between classes.
